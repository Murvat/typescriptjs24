...
abstract class CF {
    ...
    abstract sendEmail(email: string): boolean;
}
...
class ContactForm extends CF {
    ...
    constructor(email: string, name: string, body: string, subject: string, verifyCode: string) {
        super();
        this.email = email;
        this.name = name;
        this.body = body;
...
abstract class ArticleInstance {
    abstract article_id: number;
    abstract author_id: number;
    abstract language: string;
    abstract created: number;
    abstract updated: number;
    abstract published: string;
    abstract hits_count: number
    abstract intro_text: string
    abstract full_text: string;
    abstract title: string;
    abstract meta_keywords: string;
    abstract meta_description: string;
