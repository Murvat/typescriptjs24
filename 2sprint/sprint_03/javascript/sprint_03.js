...
let error_6 = false;
function f06() {
    let input1 = parseInt(document.querySelector('input.i-61').value);
    let input2 = parseInt(document.querySelector('input.i-62').value);
    sum_6 = input1 + input2;
    if (sum_6 > 0) {
...
let max_7;
function f07() {
    let input1 = document.querySelector('input.i-71').value;
    let input2 = document.querySelector('input.i-72').value;
...
let val_8;
function f08() {
    val_8 = document.querySelector('select.s-8').value;
...
let val_9 = 5;
function f09() {
    let option = document.querySelector('select.s-9').selectedIndex;
    option = val_9;
...
let res_10 = false;
function f10() {
    let checkbox = document.querySelector('input.ch-10');
...
let res_11 = 0;
function f11() {
    let checkbox = document.querySelector('input.ch-11');
...
let res_12 = 0;
function f12() {
    let checkbox = document.querySelector('input.ch-12');
...
function f13() {
    let input = parseInt(document.querySelector('input.i-13').value);
    let resStr = '';
    while (input >= 0) {
        resStr = resStr + input;
        input--;
...
let res_14;
function f14() {
    let input = parseInt(document.querySelector('input.i-14').value);
...
let res_17 = false;
function f17() {
    let input = document.querySelector('input.i-17');
...
let s_19;
function f19() {
    let input = parseInt(document.querySelector('input.i-19').value);
    let resStr = '';
    while (input > 0) {
        if (input % 2 === 0) {
            resStr = resStr + 'x' + '_';
...
let s_20 = 0;
function f20() {
    let input = parseInt(document.querySelector('input.i-20').value);
    while (input >= 0) {
        s_20 = s_20 + input;
        input--;
    }
