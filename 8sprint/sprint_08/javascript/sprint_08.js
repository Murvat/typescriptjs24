...
const f_05 = () => {
    let out = '';
    let specArr = obj_05.specifications;
    specArr.forEach(elem => out += elem + '_');
    return out;
};
...
const f_06 = () => {
    ...
    // let arr = Object.values(obj_06)
    //     .forEach(elem => out += elem + '_')
    return out;
};
...
const f_07 = () => {
    let out = obj_07.balls
        .reduce((accum, initValue) => accum > initValue ? accum : initValue, obj_07.balls[0]);
    return out;
};
